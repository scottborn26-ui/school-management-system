...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    roles: ["admin", "principal", "deputy", "registrar", "teacher", "class_teacher"],
  },
  {
    to: "/transition",
    label: "Grade 9 Transition",
    icon: faGraduationCap,
    roles: ["principal", "deputy", "registrar", "super_admin"],
  },
  ...
  },
  {
    ...
    icon: faSchool,
    roles: ["principal", "deputy", "registrar"],
  },
  {
    to: "/curriculum",
    label: "Curriculum",
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-20 flex flex-wrap items-center gap-3 border-b border-border bg-white/95 px-4 py-3 shadow-[0_1px_2px_rgba(15,23,42,0.03)] backdrop-blur transition-shadow duration-200 no-print">
          <Sheet>
