...
function GradingPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-7 pb-8">
      ...
      <Card className="overflow-hidden border-slate-200/80 bg-slate-50/45 shadow-sm dark:border-border/70 dark:bg-card/70 dark:shadow-none">
        <CardHeader className="border-b border-border/70 pb-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-500 dark:border-border dark:bg-background dark:text-muted-foreground">
