...
function EditStaffDialog({
  ...
  const mutation = useMutation({
    ...
    onError: () => toast.error("The staff member could not be updated."),
  });
  function submit() {
    ...
    mutationFn: async () => {
      const account = await createStaffWithAccount({
        data: {
          ...
          role: form.role as "teacher" | "class_teacher" | "registrar" | "bursar" | "exam_officer",
        ...
        <FieldRow label="Account role *">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="bursar">Accountant / bursar</SelectItem>
            </SelectContent>
          </Select>
        </FieldRow>
