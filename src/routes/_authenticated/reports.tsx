    ...
    <>
      ...
      {selected && payload && (
        <>
          ...
          >
            {/* Masthead */}
            <div className="report-block border-b bg-primary px-6 py-3 text-primary-foreground">
            ...
            <div className="report-block px-6 pt-3">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {payload.areas.map((a) => (
                      <tr key={a.learning_area} className="report-table-row">
                        <td className="font-medium">{a.learning_area}</td>
                        <td className="text-right tabular-nums">{a.percentage.toFixed(1)}%</td>
