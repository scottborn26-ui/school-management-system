-- Recreate the Senior School placement function with a single explicit assignment_id
-- source so the transition insert cannot hit the "column reference assignment_id is ambiguous"
-- error when recording a Grade 9 transition.
